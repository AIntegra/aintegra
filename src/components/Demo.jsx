...
export default function Demo({ t }) {
  return (
    <section>
      <h2 className="text-3xl md:text-4xl font-semibold tracking-tight bg-gradient-to-r from-indigo-400 via-sky-400 to-fuchsia-400 bg-clip-text text-transparent mb-4">
        {t.demo.title}
      </h2>
      <p className="text-neutral-300 mb-8">{t.demo.subtitle}</p>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {t.commands.map((c, i) => (
          ...
          >
            <c.icon className="h-5 w-5 mb-2 text-indigo-300" />
